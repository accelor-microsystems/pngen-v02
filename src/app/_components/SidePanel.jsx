...
export default function SidePanel() {
    return (
        <div className="flex bg-gradient-to-tr from-green-900 to-purple-900 flex-col p-6 items-center justify-center w-full flex-1 max-sm:flex-[0.3] min-h-[100vh] max-sm:min-h-[10vh]">
