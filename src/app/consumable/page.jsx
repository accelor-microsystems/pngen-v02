    ...
    return (
        <div className="flex">
            ...
            <div className={dataSaving === true ? `flex flex-[2]  opacity-[0.5] items-center h-[100vh] justify-center relative` : `flex flex-[2] items-center h-[100vh] justify-center relative`}>
                ...
                <Link href='/view-data/consumable'><button className="absolute top-7 bg-slate-700 text-white px-5 py-3 rounded-lg left-4 hover:bg-slate-600">View Data</button></Link>
                {
                    validationWindow &&
