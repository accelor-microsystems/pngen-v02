...
export default function MechElecPage({ broadCategory }) {
    ...
    return (
        <div className={dataSaving === true ? `flex items-center justify-center opacity-[0.5]  h-[100vh]` : `flex flex-[2] items-center justify-center opacity-1`}>
